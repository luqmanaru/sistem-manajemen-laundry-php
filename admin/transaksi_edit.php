...
<div class="container">
    <div class="panel">
        ...
        <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="pelanggan" required="required">
                                ...
                                while ($d = mysqli_fetch_array($data)) { 
                                    ?>
                                    <option <?php if ($d['idPelanggan'] == $t['transaksi_pelanggan']) {echo "selected='selected'";} ?> 
                                    value="<?php echo $d['idPelanggan']; ?>"><?php echo $d['namaPelanggan']; ?></option> 
                                    <?php } ?>
                            </select>
                        </div>
                        <label>Berat</label>
            ...
            <div class="form-group alert alert-info"> <label>Status</label>
